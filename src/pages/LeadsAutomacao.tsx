...
function dedupeKey(e: LeadAutomacao): string {
  ...
  const name = (e.nome || e.name || "").normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase().replace(/\s+/g, " ").trim();
  const phone = (toStr(e.whatsapp) || toStr(e.telefone) || toStr(e.telefone_raw) || toStr(e.phone) || "").replace(/\D/g, "");
